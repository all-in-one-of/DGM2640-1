...
//Name: narwhal.ma
//Last modified: Fri, Jan 18, 2019 10:59:55 AM
//Codeset: 1252
requires maya "2018";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 8.2977709665132622 1.1619903412199595 0.33177421576507649 ;
	setAttr ".r" -type "double3" -1.5383527284729688 440.99999999984738 -1.906082533062694e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "39E09FB6-40B7-04E8-7A79-C4A6A5791549";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 6.4473261537299287;
...
createNode mesh -n "pCubeShape2" -p "pCube2";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.49999998509883881 0.38038003444671631 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 14 ".pt";
	setAttr ".pt[65]" -type "float3" 0 0.065547988 0 ;
	setAttr ".pt[66]" -type "float3" 0 0.056147721 0 ;
	setAttr ".pt[68]" -type "float3" 0 0.056147721 0 ;
	setAttr ".pt[69]" -type "float3" 0 0.065547988 0 ;
	setAttr ".pt[73]" -type "float3" 0 0.041908506 0 ;
	setAttr ".pt[77]" -type "float3" 0 0.041908506 0 ;
	setAttr ".pt[81]" -type "float3" 0 0.052683856 0 ;
	setAttr ".pt[82]" -type "float3" 0 0.15227324 -0.17170058 ;
	setAttr ".pt[84]" -type "float3" 0 0.15227324 -0.17170058 ;
	setAttr ".pt[85]" -type "float3" 0 0.052683856 0 ;
	setAttr ".pt[89]" -type "float3" 0 0.061805639 0 ;
	setAttr ".pt[90]" -type "float3" 0 0.046018269 0 ;
	setAttr ".pt[92]" -type "float3" 0 0.046018269 0 ;
	setAttr ".pt[93]" -type "float3" 0 0.061805639 0 ;
	setAttr ".ai_translator" -type "string" "polymesh";
