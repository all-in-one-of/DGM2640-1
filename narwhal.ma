...
//Name: narwhal.ma
//Last modified: Sun, Jan 20, 2019 10:30:15 PM
//Codeset: 1252
requires maya "2018";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 5.6635429736635281 1.1387778698458966 6.3441333508187752 ;
	setAttr ".r" -type "double3" 357.2616472715016 386.59999999948428 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "39E09FB6-40B7-04E8-7A79-C4A6A5791549";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 7.3322531667134898;
...
createNode mesh -n "pCubeShape2" -p "pCube2";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 8 ".pt";
	setAttr ".pt[0]" -type "float3" 0 0.0063897832 0 ;
	setAttr ".pt[1]" -type "float3" 0 0.0063897832 0 ;
	setAttr ".pt[27]" -type "float3" 0 0.0086971726 0 ;
	setAttr ".pt[29]" -type "float3" 0 0.0086971726 0 ;
	setAttr ".pt[259]" -type "float3" 0 0.035026018 0 ;
	setAttr ".pt[265]" -type "float3" 0 0.035026018 0 ;
	setAttr ".pt[277]" -type "float3" 0 0.025465913 0 ;
	setAttr ".pt[283]" -type "float3" 0 0.025465913 0 ;
	setAttr ".ai_translator" -type "string" "polymesh";
